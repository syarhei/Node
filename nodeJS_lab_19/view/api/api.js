...
module.exports = () => {
    function Api() {
        ...
        this.getFutureWeather = getFutureWeather;
        ...
        function getFutureWeather(id) {
            return new Promise((resolve, reject) => {
                axios.get('http://api.openweathermap.org/data/2.5/forecast?appid=900ef9b8e3d5948c8a16df01f60e1049&id=' + id.toString()).then(array => {
                    resolve(array);
                }).catch(console.log);
            });
        }
